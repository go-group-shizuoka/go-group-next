...
export const DUMMY_CHILDREN: Child[] = [
  ...
  },
  {
    ...
    diagnosis: "自閉スペクトラム症", use_days: ["火","木","金","土"],
    has_transport: false, active: true,
  ...
  {
    id: "c6", org_id: "org_1", facility_id: "f3",
    name: "加藤 みさき", name_kana: "かとう みさき",
    dob: "2015-02-14", grade: "小3", gender: "女",
    diagnosis: "発達障害", use_days: ["月","水","土"],
    has_transport: true, active: true,
    parent_name: "加藤 由紀", parent_phone: "000-0000-0006",
    notes: "感覚過敏あり。騒音に配慮。",
    support_content: "感覚統合・コミュニケーション支援",
    created_at: "2024-04-01T00:00:00Z",
  },
  {
    id: "c7", org_id: "org_1", facility_id: "f4",
    name: "松本 ゆうと", name_kana: "まつもと ゆうと",
    dob: "2014-08-22", grade: "小4", gender: "男",
    diagnosis: "自閉スペクトラム症", use_days: ["月","火","土"],
    has_transport: true, active: true,
    parent_name: "松本 健二", parent_phone: "000-0000-0007",
    notes: "ルーティンを大切に。急な変更は事前告知を。",
    support_content: "社会性・日常生活動作",
    created_at: "2024-04-01T00:00:00Z",
  },
  {
    id: "c8", org_id: "org_1", facility_id: "f4",
    name: "井上 はな", name_kana: "いのうえ はな",
    dob: "2016-05-10", grade: "小2", gender: "女",
    diagnosis: "知的障害", use_days: ["水","金","土"],
    has_transport: false, active: true,
    parent_name: "井上 美紀", parent_phone: "000-0000-0008",
    notes: "言葉でのコミュニケーションが苦手。絵カード活用。",
    support_content: "言語療育・生活スキル",
    created_at: "2024-04-01T00:00:00Z",
  },
];
